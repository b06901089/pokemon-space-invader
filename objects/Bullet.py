...
#         # pygame.image.save(image, "img/edited/smooth_bullet.png")  # cache the processed bullet

#         self.image = pygame.image.load(C.BULLET_PATH_SMOOTH).convert_alpha()
#         self.rect = self.image.get_rect()
#         self.rect.center = (x, y)
#         self.bullet_dir = C.BULLET_X_SPEED[mode]
